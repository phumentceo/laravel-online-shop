        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <h3>Color</h3>
                <p data-bs-toggle="modal" data-bs-target="#modalCreateColor" class="card-description btn btn-primary ">new brand</p>
            </div>
...
<script>
            ...
            if(response.status == 200){
                ...
                $.each(colors, function (key,value) { 
                    ...
                    <tr>
                        ...
                        <th>
                            <button type="button" onclick="ColorEdit(${value.id},'${value.name}','${value.color_code}')" class=" btn btn-info  btn-sm" data-bs-toggle="modal" data-bs-target="#modalUpdateColor">Edit</button>
   ...
   const ColorEdit = (id,name,code) => {
       $(".name_edit").val(name);
       $(".color_code_update").val(code);
       $("#color_id").val(id);
   }
